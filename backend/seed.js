    ...
    const houses = [
        {
            ...
            players: ["Akshay Kumavat", "Anant Sharma", "Aayush Dubey","Daksh Kumavat","Dhruv Vora", "Heet Soni", "Jaypal Purohit", 
                "Krish Kumavat", "Manav Soni", "Rahul Bhai Chaudhari", "Nakul Kumavat", "Yash Panchal", "Deep Parmar"
],
        },
        {
            name: "Neptune House",
            ...
            players: ["Aayush Thaker", "Alok Shukla", "Dev Gupta","Dhairya Gajjar", "Dhruv Gadhiya", "Grantham Suthar", "Harsh Sanghvi", "Manan Lakhani", "Nishant Bhutani", "Piyush Purohit", "Shivansh Garg", "Yash Borad", "Krishna Gupta", "Mayank Mistry"
]
        },
        {
            name: "Venus House",
            ...
            players: ["Achal Thanvi", "Aarush Dudhat", "Dev Chudasama","Dharmik Parmar", "Jignesh Parmar", "Veer Chheda", "Prabodh Sawant", "Pruthavi Rathod", "Rachit Doshi", "Rajveer Solanki", "Shlok Makwana", "Tirth Shah", "Vrutant Ajmera"]
        },
        {
            name: "Jupiter House",
            coaches: ["Parth Bhai Darji", "Keyur Bhai Panchal"],
            mentors: ["Kunal Bhai Pandya", "Jay Bhai Darji"],
            players: ["Ansh Darji", "Ashish Darji", "Daksh Rathod", "Kartik Gupta", "Krishna Pitroda", "Mayakrishna Yadav", "Naman Jugran", "Nirmal Boricha", "Rahul Kumavat", "Samarth T", "Shavan Bhardwaj", "Yash Bhola", "Shivam Sharma"]
        }
    ];
